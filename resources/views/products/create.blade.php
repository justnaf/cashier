    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form action="{{ route('products.store') }}" method="POST" class="w-full max-w-sm mx-auto"
                        ...
                        <div class="md:flex md:items-center mb-6">
                            ...
                            <div class="md:w-2/3">
                                <input
                                    class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight"
                                    id="st" type="number" name="stock" value="0">
                        ...
                        <div class="md:flex md:items-center mb-6">
                            ...
                            <div class="md:w-2/3">
                                <input
                                    class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight"
                                    id="cs" type="number" name="cost" value="0">
                        ...
                        <div class="md:flex md:items-center mb-6">
                            ...
                            <div class="md:w-2/3">
                                <input
                                    class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight"
                                    id="pr" type="number" name="price" value="0">
